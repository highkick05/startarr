...
(async () => {
    console.log("Empty:", await getBetterTitle('', 'https://adgaurd.mailboy.org'));
    console.log("Domain:", await getBetterTitle('adgaurd.mailboy.org', 'https://adgaurd.mailboy.org'));
    console.log("Login:", await getBetterTitle('Login', 'https://adgaurd.mailboy.org'));
})();
